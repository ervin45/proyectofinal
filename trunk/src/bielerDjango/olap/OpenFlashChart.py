...
class graph:
    ...
    def render_js(self):
        ...
        output_variables.remove("__doc__")
        output_variables.remove("__module__")
        output_variables.remove("data")
        output_variables.remove("lines")
        output_variables.remove("line_default")
