# Django settings for bielerDjango project.
...
DATABASE_NAME = 'bieler_dw_backup'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wj^p_%!0ao#iumz4-mf@w4imak8a7$-3)db@b*iobh&ii227ti'
